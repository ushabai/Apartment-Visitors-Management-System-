...
$sql="update tblvisitor set  categoryName='$categoryName' ,VisitorName='$VisitorName',MobileNumber='$MobileNumber',Address='$Address',Apartment='$Apartment',Floor='$Floor',
WhomtoMeet='$WhomtoMeet',ReasontoMeet='$ReasontoMeet' where ID='$id'";
...
<head>
    ...
    <!-- Title Page-->
    <title>AVSM | Update Visitor</title>
...
?>            
                    ...
                    <input type="number" id="Floor" name="Floor" class="form-control"  value="<?php  echo $row['Floor'];?>" required="true">
                                                ...
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">WhomtoMeet</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                    <input type="text" id="WhomtoMeet" name="WhomtoMeet" class="form-control"  value="<?php  echo $row['WhomtoMeet'];?>" required="true">
                                                    
                                                </div>
                                                   
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">ReasontoMeet</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                    <input type="text" id="ReasontoMeet" name="ReasontoMeet" class="form-control"  value="<?php  echo $row['ReasontoMeet'];?>" required="true">
